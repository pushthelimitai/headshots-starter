        ...
        if (message.text && message.text.startsWith('/')) {
            ...
            switch (command) {
                ...
                case 'connect':
                    ...
                    await bot.api.sendMessage(chatId, 'Чтобы связать ваш Telegram с аккаунтом в приложении, выполните следующие шаги:\n\n' +
                    ...
                    break;
                case 'help':
                    await bot.api.sendMessage(chatId, 'Доступные команды:\n' +
 ...
 */
async function processCallback(bot, callbackQuery) {
    try {
